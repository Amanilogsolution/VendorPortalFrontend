    ...
    <NavPage />
      <div className="TotalInvoices">
        ...
        <div className="container">
          ...
          <h2 className="text-dark mt-5">View Invoices</h2>
          <button type="button" style={{ float: "right" }} onClick={() => { window.location.href = "./AddInvoices" }} class="btn btn-secondary">Add Invoice</button>
